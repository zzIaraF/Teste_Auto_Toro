...
Quando preencho os dados pessoais de Data
    [Arguments]    ${DataNasc}   
...
Quando preencho os dados pessoais restantes
    #Genero
    Wait Until Element Is Visible  xpath=${DadosPessoais.Genero}     40
...
Dado que preencho os dados patrimoniais
    #profissao
    Wait Until Element Is Visible  xpath=${DadosPatrimonio.Selection_Profissão}     10
    Click Element   xpath=${DadosPatrimonio.Selection_Profissão}   
    Click Element    xpath=${DadosPatrimonio.Opc_Profisao} 
    ...
    #Proxima pagina 
    Click Element   xpath=${DadosPatrimonio.Button_ContinuaPatri}

Quando seleciono o principal objetivo ao abrir uma conta 
    Wait Until Element Is Visible   xpath=${Quasela.Opc_Obj}    40
    Click Element  xpath=${Quasela.Opc_Obj}
